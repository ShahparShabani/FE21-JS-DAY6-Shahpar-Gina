...
for (let i = 0; i < booksParse.length; i++) {
    ...
    <div class="card-body ${readParse ? "read" : "not-read"}">
      <h5 class="card-title"><a class="" data-bs-toggle="modal" data-bs-target="#carModal${i}">
      ${booksParse[i].title}
    </a></h5>
  ...
  <!-- Modal -->
  <div class="modal fade" id="carModal${i}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
